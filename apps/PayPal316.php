...
class PayPal{
	...
	public function __construct($db){
		...
		elseif(OUR_DOMAINNAME=='repairstorepos.com') {	
			$this->AUTH_TOKEN_URL = "http://api.paypal.com/v1/oauth2/token";
			$this->PRODUCT_URL = "http://api.paypal.com/v1/catalogs/products";
			$this->PLAN_URL = "http://api.paypal.com/v1/billing/plans";
			$this->SUBSCRIPTIONS_URL = "http://api.paypal.com/v1/billing/subscriptions";
			$this->WEBHOOKS_URL = "http://api.paypal.com/v1/notifications/webhooks";
			$this->CLIENT_ID = "AanFC4YhFGXaIJB_2sefwKhOE_3sU6VBpKn5jvx2XnBWOoumz9IAwAsKrlswsYHLfkkMgv-fFeH9p7QE";
			$this->CLIENT_SECRET = "EICazfvs4lhDmIZDC9wow4_eJS79g4Vl88ZiAo19Px33VVSLOLSetsLTcqSfeEYMwZPG4ue9-qDmu2pe";
		}
		else{
			$this->AUTH_TOKEN_URL = "http://api.paypal.com/v1/oauth2/token";
			$this->PRODUCT_URL = "http://api.paypal.com/v1/catalogs/products";
			...
			$this->SUBSCRIPTIONS_URL = "http://api.paypal.com/v1/billing/subscriptions";
			$this->WEBHOOKS_URL = "http://api.paypal.com/v1/notifications/webhooks";
			$this->CLIENT_ID = "AYcy20UCuH8bU6U7tO8cRKAa2SiCgnvxp9-1xI9ddDg8mzqEX2WP7PRm6_lTfCTP3A8xJ3JGRj37ZY0y";
			$this->CLIENT_SECRET = "EBTcuFgdRWQz4RCxSchVs3crleQTnU59fXV0RnH7oD66FrZu1TjtOERv8UOEiKYgtZOETcJ-lqZNeqTy";
		}
	}
