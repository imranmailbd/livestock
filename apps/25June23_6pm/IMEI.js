...
function lists(){
    ...
    [
        ...
        const titleRow = cTag('div', {'class':'outerListsTable','style': "padding: 5px; text-align: start;"});
            ...
            headerTitle.innerHTML = Translate('Livestock Inventory');
...
function view(){
    ...
    showTableData.innerHTML = '';
        ...
        titleRow.appendChild(headerTitle);
            const inventoryListLink = cTag('a', {class: "btn defaultButton", 'href':"/IMEI/lists", title:Translate('Livestock Inventory')});
