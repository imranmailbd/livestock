...
class Db{
	...
	public function __construct(){
		try {	
			$username = 'skitsbd_livestock';  //livestock
			$password = 'livestock123!@#';
			$database = 'skitsbd_livestock';
			if(strcmp(OUR_DOMAINNAME, 'skitsbd.com') != 0) {  //livestock.com
				$username = 'root';
				$password = '';
				$database = 'livestock';
			}	
	...
	public function checkCharLen($tableField, $charStr){
		...
		'item.tag_color'=>50,
		'item.alt_tag'=>120,
		'item.anml_description'=>255,
		'item.arrival_weight'=>25,
		'item.arrival_type'=>50,
		'item.arrival_note'=>255,
		'item.birth_weight'=>25,
		'item.birth_type'=>50,
		'item.calving_assist_reason'=>255,
		'item.birth_location'=>255,
		'item.wean_weight'=>25,
		'item.purpose'=>120,
