...
if(count($serverexp)>2){
	$subdomain = implode(array_slice($serverexp, -4, 1));
}
...
if(!in_array(OUR_DOMAINNAME, array('livestock.skitsbd.com', 'livestock.com', 'livestockl.com'))){
	echo 'There has been a error with your request.  If you have questions please email support@skitsbd.com';
	exit;
}

if(in_array(OUR_DOMAINNAME, array('machousel.com.bd'))){error_reporting(-1);}
