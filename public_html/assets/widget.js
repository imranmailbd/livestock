...
function AJload_filtered_WidgetForm(){	
	...
	const widgetInfo = {
		...
		cellPhones:{title:'Mobile Devices',type:'Mobile Devices'}
	}
	const sproduct_type = {services:"Labor/Services",product:'Standard',cellPhones:'Mobile Devices'};
	const header = {services:"Services",product:'Products',cellPhones:'Mobile Devices'};
