import {
    cTag, Translate, tooltip, showTopMessage, setOptions, getMobileOperatingSystem, AJremove_tableRow, fetchData, actionBtnClick, leftsideHide, copyToClipboardMsg
} from './common.js';
...
async function AJ_squareup_MoreInfo(){
    ...
    function afterFetch(data){
        ...
        if(variables_id===0){
            const deviceOpSy = getMobileOperatingSystem();
