...
class Template{
	...
	public function footerHTML(){
		...
		if(in_array($jsfileName, array('POS', 'Customers', 'Products', 'Manage_Data'))){$type = 'module';}
		...
		if(in_array($GLOBALS['segment2name'], array('POS', 'Repairs', 'Invoices', 'Purchase_orders', 'Orders', 'Inventory_Transfer', 'Stock_Take'))){
		    if(commonJSmodule ==''){
			    $htmlStr .= "
