...
class PHPMailer
{
     ...
     *
     * @see http://tools.ietf.org/html/rfc3461 See section 4.1 for more information about NOTIFY
     */
    public $dsn = '';
     ...
     * as suggested by http://www.rfc-editor.org/rfc/rfc2045#section-6.7
     *
     * @return void
     */
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'html5':
                 ...
                 *
                 * @see http://html.spec.whatwg.org/#e-mail-state-(type=email)
                 */
                return (bool) preg_match(
    ...
    protected function sendmailSend($header, $body)
    {
        ...
        //Example problem: http://www.drupal.org/node/1057954
        ...
        if (!empty($this->Sender) && static::validateAddress($this->Sender) && self::isShellSafe($this->Sender)) {
            ...
            //<http://github.com/PHPMailer/PHPMailer/issues/2298>), and
     ...
     *
     * @see http://github.com/PHPMailer/PHPMailer/issues/924 CVE-2016-10045 bug report
     *
    ...
    {
        //Matches scheme definition from http://tools.ietf.org/html/rfc3986#section-3.1
    ...
    public function createHeader()
    {
        ...
        if ('' === $this->XMailer) {
            ...
            $result .= $this->headerLine(
                'X-Mailer',
                'PHPMailer ' . self::VERSION . ' (http://github.com/PHPMailer/PHPMailer)'
            );
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                //Workaround for PHP bug http://bugs.php.net/bug.php?id=69197
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' === $key) {
                ...
                return $this->language[$key] . ' http://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting';
            }
     ...
     *
     * @see http://tools.ietf.org/html/rfc6376#section-3.4.2
     *
     ...
     *
     * @see http://tools.ietf.org/html/rfc6376#section-3.4.3
     *
     * @param string $body Message Body
     *
     * @return string
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        //Recommended list from http://tools.ietf.org/html/rfc6376#section-5.4.1
        $autoSignHeaders = [
            'from',
            'to',
            'cc',
