...
const listsFieldAttributes = [
    {'datatitle':Translate('Livestock ID'), 'align':'center'},
    {'datatitle':Translate('Livestock Name'), 'align':'left'},
    {'datatitle':Translate('Color Name'), 'align':'left'},
    {'datatitle':Translate('TAG No'), 'align':'left'},
    {'datatitle':Translate('Purchase Price'), 'align':'right'},
...
const weightFieldAttributes = [
	...
	{'valign':'top','datatitle':Translate('Action'), 'align':'center'}
];
        ...
        if(data.productWeight.length>0){
            ...
            if(tableData.length){                    
                tableData.forEach(oneRow => { 
                    ...
                    // let idVal = oneRow[0];
                    // let reviewDate = oneRow[1];
                    // let height = oneRow[2];
                    // let weight = oneRow[3];
                    // let product_id = oneRow[4];

                    //$product_growthinfo_id, $datestr, $growth, $weight, $product_id
                    ...
                    const productWeightTable = cTag('table', {class: "table-bordered table-striped table-condensed cf listing", 'style': "margin: 0;"});
                        const productWeightHead  = cTag('thead', {class: "cf"});
                            ...
                            const productWeightRow = cTag('tr');
                                ...
                                const th4Col0 = cTag('th', {'style': "width: 20px;"});
                                th4Col0.innerHTML = column4Names[0];

                                const th4Col1 = cTag('th', {'style': "width: 80px;"});
                                th4Col1.innerHTML = column4Names[1];

                                const th4Col2 = cTag('th', {'style': "width: 80px;"});
                                th4Col2.innerHTML = column4Names[2];

                                const th4Col3 = cTag('th', {'style': "width: 80px;"});
                                th4Col3.innerHTML = column4Names[3];
                                ...
                                productWeightRow.append(th4Col0, th4Col1, th4Col2, th4Col3);
    ...
    function afterFetch(data){
		...
		if(data.login !==''){
            ...
            formDialog.appendChild(cTag('div',{ 'class': 'errormsg','id': '' }));
                    ...
                    let divTabs3 = cTag('div',{ 'class': 'columnXS12','id': 'tabs-3' , 'style': "border:0px solid red;"});
                        ...
                        const motherNameTitle = cTag('div',{ 'class':'columnXS12 columnSM4' });
                            let motherNameLabel = cTag('label',{ 'for':'lsproduct','data-placement':'bottom' });
						...
						const maternalDiv = cTag('div',{ 'class': 'LiveStocks manage_maternal_block' });
                            const maternalRow = cTag('div',{ 'class': 'flex', 'style': "margin-bottom: 10px;" });
                                let maternalLabel = cTag('label',{ 'for': 'manage_maternal_block' });
                                    inputField = cTag('input',{ 'type': 'checkbox','name': 'manage_maternal_block','id': 'manage_maternal_block' });
                                    if(data.manage_maternal_block){                                        
                                        inputField.setAttribute('checked',true);
                                    }
                                    inputField.addEventListener('click',checkMaternalBlock);
                                    maternalLabel.appendChild(inputField);
                                    maternalLabel.append(' '+Translate('External Parent (Mother)'));
                        ...
                        const altTagRowMaternal = cTag('div',{ 'class': 'flex manage_maternal_block_out', 'style': "text-align: left; display:none" });
                            const altTagTitleMaternal = cTag('div',{ 'class': 'columnXS12 columnSM4' });
                                const altTagLabelMaternal = cTag('label',{ 'for': 'pedigree_rfid_tag' });
                        ...
                        const breedRowMaternal = cTag('div',{ 'class': 'flex manage_maternal_block_out', 'style': "text-align: left; display:none" });
                            const breedTitleMaternal = cTag('div',{ 'class': 'columnXS12 columnSM4' });
                                const breedLabelMaternal = cTag('label',{ 'for': 'breed_id_maternal' });
                            ...
                            const breedDropDownMaternal = cTag('div',{ 'class': 'columnXS12 columnSM8' });
                                const breedInGroupMaternal = cTag('div',{ 'class': 'input-group' });
                                    let selectBreedMaternal = cTag('select',{ 'class': 'form-control','name': 'breed_id_maternal','id': 'breed_id_maternal' });
                                    ...
                                    breedDropDownMaternal.appendChild(cTag('span',{ 'class': 'error_msg','id': 'errmsg_breed_id_maternal' }));
                        ...
                        const maternalNameRow = cTag('div',{ 'class': 'flex manage_maternal_block_out', 'style': "text-align: left; display:none" });
                            const maternalNameTitle = cTag('div',{ 'class': 'columnXS12 columnSM4' });
                                const maternalNameLabel = cTag('label',{ 'for': 'mother_name' });
                        ...
                        const noTeethDivMother = cTag('div',{ 'class': 'manage_maternal_block_out', 'style': "text-align: left; display:none" });
                            const noTeethRowMother = cTag('div',{ 'class': 'flex', 'style': "text-align: left;" });
                                const noTeethTitleMother = cTag('div',{ 'class': 'columnXS12 columnSM4' });
                                    const noTeethLabelMother = cTag('label',{ 'for': 'no_teeth_mother','data-toggle': 'tooltip','data-placement': 'bottom' });
                        ...
                        const birthWeightDivMother = cTag('div',{ 'class': 'manage_maternal_block_out', 'style': "text-align: left; display:none" });
                            const birthWeightRowMother = cTag('div',{ 'class': 'flex', 'style': "text-align: left;" });
                                const birthWeightTitleMother = cTag('div',{ 'class': 'columnXS12 columnSM4' });
                                    const birthWeightLabelMother = cTag('label',{ 'for': 'birth_weight_mother','data-toggle': 'tooltip','data-placement': 'bottom' });
                                    ...
                                    birthWeightFieldMother.appendChild(cTag('input',{ 'maxlength': '6','type': 'text','name': 'birth_weight_mother','id': 'birth_weight_mother','class': 'form-control','value': data.last_weight_mother }));
                        ...
                        const birthHeightDivMother = cTag('div',{ 'class': 'manage_maternal_block_out', 'style': "text-align: left; display:none" });
                            const birthHeightRowMother = cTag('div',{ 'class': 'flex', 'style': "text-align: left;" });
                                const birthHeightTitleMother = cTag('div',{ 'class': 'columnXS12 columnSM4' });
                                    const birthHeightLabelMother = cTag('label',{ 'for': 'birth_height_mother','data-toggle': 'tooltip','data-placement': 'bottom' });
                                    ...
                                    birthHeightFieldMother.appendChild(cTag('input',{ 'maxlength': '6','type': 'text','name': 'birth_height_mother','id': 'birth_height_mother','class': 'form-control','value': data.last_height_mother }));
                        ...
                        const currentAddressTitleMother = cTag('div',{ 'class': 'columnXS12 columnSM4'});
                            const currentAddressLabelMother = cTag('label',{ 'for': 'current_address_mother' });
                        ...
                        const anmlDescriptionRowMother = cTag('div',{  'class': 'flex manage_maternal_block_out', 'style': "text-align: left; display:none" });
                            const anmlDescriptionTitleMother = cTag('div',{ 'class': 'columnXS12 columnSM4'});
                                const anmlDescriptionLabelMother = cTag('label',{ 'for': 'anml_description_mother' });
                        ...
                        const altTagRowPaternal = cTag('div',{ 'class': 'flex manage_paternal_block_out', 'style': "text-align: left; display:none" });
                            const altTagTitlePaternal = cTag('div',{ 'class': 'columnXS12 columnSM4' });
                                const altTagLabelPaternal = cTag('label',{ 'for': 'ppedigree_rfid_tag' });
			...
			setTimeout(function() {
                ...
                let manage_maternal_blockid_checkbox = document.getElementById("manage_maternal_block");
				if(data.manage_maternal_block && manage_maternal_blockid_checkbox.checked===true){	
                    ...
                    document.getElementById("lsproduct").value = data.mother_tag;
                    document.getElementById("lsproduct_id").value = data.lsproduct;
